...
- 개인에게는 삶의 활력을, 기업에는 경쟁력을, 사회에는 고령화 사회에 대응해 국가 전체의 생산성을 향상
  ...
  <img src="https://github.com/user-attachments/assets/c2bbd78a-b40a-4504-ad56-65217fafd79b" width="450">
...
<img src="https://github.com/user-attachments/assets/ae25905d-d9d3-46fc-b7e9-376460b3c07a" width=450>
...
| **항목**            | **상세 정보**                                                                                  |
|---------------------|-----------------------------------------------------------------------------------------------|
| **프론트엔드🌐**      | ![](https://img.shields.io/badge/Vue.js-4FC08D?style=flat-square&logo=Vue.js&logoColor=white) <br> ![](https://img.shields.io/badge/Express.js-000000?style=flat-square&logo=Express&logoColor=white) |
...
유연하고 안정적인 인프라를 위해 **3-Tier 아키텍처**를 채택하였습니다:
...
AWS의 물리적 데이터 센터를 활용하여, 하나의 데이터 센터에 장애가 발생하더라도 서비스가 정상적으로 운영될 수 있도록 설계되었습니다.

## 🖥️ 계층별 상세 설명

### 🎨 Presentation Tier

- **Vue.js** 기반의 프론트엔드와 **Express.js** 서버로 사용자 상호작용을 처리
...
- **AWS WAF**: 비정상적인 트래픽 및 SQL 인젝션 방어
- **CSRF 방어**: 요청마다 토큰을 검증하여 비인가 요청을 차단
